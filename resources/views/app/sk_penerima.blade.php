...
<script src="{{ asset('js/web/sk_penerima.js?v=17') }}"></script>
<script src="{{ asset('js/web/penerima.js?v=17') }}"></script>
<script src="{{ asset('js/web/jadwal_monitoring.js?v=17') }}"></script>
<script src="{{ asset('js/web/verifikator_laporan.js?v=17') }}"></script>
