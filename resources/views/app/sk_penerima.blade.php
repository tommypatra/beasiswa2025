...
<script src="{{ asset('js/web/sk_penerima.js') }}"></script>
<script src="{{ asset('js/web/penerima.js') }}"></script>
<script src="{{ asset('js/web/jadwal_monitoring.js') }}"></script>
<script src="{{ asset('js/web/verifikator_laporan.js') }}"></script>
