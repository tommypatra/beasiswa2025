...
<div class="card">
    <div class="card-body">
        <div class="d-sm-flex d-block align-items-center justify-content-between mb-3">
            <h5 class="card-title fw-semibold">Referensi Ruangan</h5>
                ...
                <div class="modal-body ">
                    ...
                    <div class="row">
						<div class="col-lg-5 mb-3">
                            ...
                            <input name="gedung" id="gedung" type="text" class="form-control">
                        </div>
						<div class="col-lg-4 mb-3">
                            <label class="form-label">Kapasitas</label>
                            <input name="kapasitas" id="kapasitas" type="text" class="form-control">
                        </div>
						<div class="col-lg-3 mb-3">
                            <label class="form-label">Lantai</label>
                            <input name="lantai" id="lantai" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="row">
						<div class="col-lg-12 mb-3">
...
<script type="text/javascript">
    const endpoint = base_url+'/api/ruangan';
    var page = 1;
    $(document).ready(function() {
            ...
            if (data.length > 0) {
                $.each(data, function(index, dt) {
                    const row = `<tr>
                                <td>${no++}</td>
                                <td>${dt.nama}</td>
                                <td>${showText(dt.gedung)}</td>
                                <td>${showText(dt.kapasitas)}</td>
                                <td>${showText(dt.lantai)}</td>
        ...
        $(document).on('click', '.btn-ganti', function() {
            ...
            showDataById(endpoint, id, function(response) {
                ...
                $('#gedung').val(response.data.gedung);
