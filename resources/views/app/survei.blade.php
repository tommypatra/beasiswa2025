...
@section('scriptHead')
<title>Survei Peserta Seleksi Beasiswa</title>
<style>
...
<script type="text/javascript">
    const endpoint = base_url+'/api/survei';
    var page = 1;
    ...
    $(document).ready(function() {
            ...
            if (data.length > 0) {
                $.each(data, function(index, dt) {
                    ...
                    const row = `<tr>
                                    ...
                                    <td>
                                        ${dt.beasiswa.survei_lapangan_mulai} sd 
                                        ${dt.beasiswa.survei_lapangan_selesai}
                                    </td>
                                    <td>
                                        <span class="badge rounded-pill fs-2 fw-medium bg-secondary-subtle text-secondary">Jumlah Peserta : ${dt.total_pendaftar}</span>
                                        <hr>
                                        <span class="badge rounded-pill fs-2 fw-medium bg-success-subtle text-success">Sudah Survei : ${dt.peserta_valid}</span>
        ...
        async function dataLoad() {
            ...
            var url = `${base_url}/api/survei?search=${search}`;
