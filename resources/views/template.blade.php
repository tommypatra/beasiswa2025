      ...
      <div class="body-wrapper-inner">
        <div class="container-fluid">
          ...
          <div class="py-6 px-6 text-center">
            <p class="mb-0 fs-4">Design template <a href="https://www.wrappixel.com/" target="_blank"
                class="pe-1 text-primary text-decoration-underline">Wrappixel.com</a>
                and Developed code system <a href="mailto:tommyirawanp@iainkendari.ac.id" target="_blank"
